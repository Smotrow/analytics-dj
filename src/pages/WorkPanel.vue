                ...
                .row.back-wrap
                  .col-xs-12.back
                    transition(name="fade")
                      p.weight-6(@click="previousStep" v-if="!isEnd") Back
                      p.weight-6(@click="nextStep" v-else=) Back
